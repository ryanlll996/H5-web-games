        ...
        <view class="nav-bar__wrapper">
            ...
            <view class="nav-bar__wrapper__right">
                <view class="nav-bar__left__menu">
                    <view v-if="!isOpen" class="menu-icon" @click="openMenu">
                        Menu

                        <svg width="0.875rem" height="0.8125rem" viewBox="0 0 28 26" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M25.1606 0.75C25.7206 0.75 26.1956 0.945 26.5856 1.335C26.9756 1.725 27.1706 2.2 27.1706 2.76V4.29C27.1706 4.85 26.9756 5.325 26.5856 5.715C26.1956 6.105 25.7206 6.3 25.1606 6.3H2.90062C2.34062 6.3 1.86563 6.105 1.47563 5.715C1.08563 5.325 0.890625 4.85 0.890625 4.29V2.76C0.890625 2.2 1.08563 1.725 1.47563 1.335C1.86563 0.945 2.34062 0.75 2.90062 0.75H25.1606ZM25.1606 10.14C25.7206 10.14 26.1956 10.335 26.5856 10.725C26.9756 11.115 27.1706 11.59 27.1706 12.15V13.68C27.1706 14.24 26.9756 14.715 26.5856 15.105C26.1956 15.495 25.7206 15.69 25.1606 15.69H2.90062C2.34062 15.69 1.86563 15.495 1.47563 15.105C1.08563 14.715 0.890625 14.24 0.890625 13.68V12.15C0.890625 11.59 1.08563 11.115 1.47563 10.725C1.86563 10.335 2.34062 10.14 2.90062 10.14H25.1606ZM25.1606 19.53C25.7206 19.53 26.1956 19.725 26.5856 20.115C26.9756 20.505 27.1706 20.98 27.1706 21.54V23.07C27.1706 23.63 26.9756 24.105 26.5856 24.495C26.1956 24.885 25.7206 25.08 25.1606 25.08H2.90062C2.34062 25.08 1.86563 24.885 1.47563 24.495C1.08563 24.105 0.890625 23.63 0.890625 23.07V21.54C0.890625 20.98 1.08563 20.505 1.47563 20.115C1.86563 19.725 2.34062 19.53 2.90062 19.53H25.1606Z"
                                fill="#D71E3C" />
                        </svg>

                    </view>

                    <svg class="close" v-else @click="openMenu" width="1.5rem" height="1.5rem" viewBox="0 0 48 48" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        .nav-bar__wrapper__right {
            ...
            .nav-bar__left__menu {
                ...
                .menu-icon {
                    ...
                    text-align: left;
                    color: #D71E3C;
                    padding: 0.22rem 0.34rem 0.22rem 1.03rem;
